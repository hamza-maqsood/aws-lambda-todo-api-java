# todo-service serverless API
The todo-service project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=todo-service -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=todoapp -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd todo-service
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "TodoServiceApi",
                    "OutputKey": "TodoServiceApi",
